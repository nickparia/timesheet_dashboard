...
with col3:
    avg_rate = filtered_df['Uurtarief'].mean()
    st.markdown(f"""
    <div class="metric-card">
...
with col4:
    active_staff = len(filtered_df['Medewerker'].unique())
    st.markdown(f"""
    <div class="metric-card">
...
<div class="alert-box alert-success">
    ...
    {len(df):,} records processed and ready for analysis
</div>
""", unsafe_allow_html=True)
